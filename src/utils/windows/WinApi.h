...
namespace UKControllerPlugin {
    namespace Windows {
        ...
        */
        ...
        {
            public:
            WinApi(HINSTANCE dllInstance, std::wstring filesDirectory);
            ...
            std::set<std::wstring> ListAllFilenamesInDirectory(std::wstring relativePath) const override;
            ...
            void OpenExplorer(const std::wstring& location) const override;

            // Inherited via DialogProviderInterface
            void OpenDialog(
                const UKControllerPlugin::Dialog::DialogData& dialog,
                const UKControllerPlugin::Dialog::DialogCallArgument* argument) const override;
