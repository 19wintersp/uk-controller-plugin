...
namespace UKControllerPluginTest {
    namespace Bootstrap {
        ...
        {
            public:
            LocateApiSettingsTest() : settings(mockWindows)
            {
            }
        ...
        TEST_F(LocateApiSettingsTest, LocateApiSettingsPromptsForFileAndWritesToDisk)
        {
            ...
            EXPECT_CALL(
                this->mockWindows, WriteToFile(std::wstring(L"settings/api-settings.json"), testJson.dump(), true))
                .Times(1);
        ...
        {
            ON_CALL(this->mockWindows, FileOpenDialog(_, _, _)).WillByDefault(Return(L""));
        ...
        TEST_F(LocateApiSettingsTest, ReplaceApiSettingsDoesNothingIfCancelled)
        {
            ...
            EXPECT_CALL(this->mockWindows, WriteToFile(std::wstring(L"settings/api-settings.json"), _, true)).Times(0);
        ...
        {
            EXPECT_CALL(this->mockWindows, FileOpenDialog(_, _, _)).Times(0);
